...
<!-- Navbar -->
    ...
    <main class="main-content">
        ...
        <!-- Top bar with welcome, date, notifications, profile -->
        <div class="top-bar">
            <div>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <!-- 🔔 Notifications (garde les mêmes IDs pour notifications.js) -->
                <div class="dropdown">
                ...
                <!-- Profil (garde les infos et logout) -->
    ...
    <div class="d-none d-sm-block text-start">
        ...
        <!-- ==== CONTENU DU DASHBOARD DEMANDEUR ==== -->
        <div class="container-fluid px-0">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6 col-lg-3">
                    <div class="card-stat d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted text-uppercase small fw-bold mb-1">Total demandes</p>
                            <h2 class="fw-bold m-0" id="totalRequests"><?php echo $stats['total']; ?></h2>
                        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card-stat d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted text-uppercase small fw-bold mb-1">En attente</p>
                            <h2 class="fw-bold m-0 text-warning" id="pendingRequests">
                                <?php echo $stats['en_attente'] ?? 0; ?>
                            </h2>
                        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card-stat d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted text-uppercase small fw-bold mb-1">Validées</p>
                            <h2 class="fw-bold m-0 text-success" id="approvedRequests">
                                <?php echo $stats['validee'] ?? 0; ?>
                            </h2>
                        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card-stat d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted text-uppercase small fw-bold mb-1">Rejetées</p>
                            <h2 class="fw-bold m-0 text-danger" id="rejectedRequests">
                                <?php echo $stats['rejetee'] ?? 0; ?>
                            </h2>
                        </div>
            ...
            <div class="card-stat">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold m-0">Mes demandes récentes</h5>
